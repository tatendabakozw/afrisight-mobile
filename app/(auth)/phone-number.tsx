    ...
    >
      <>
            ...
            emailExists && (
              <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginTop: 8 }}>
                <TouchableOpacity onPress={() => router.push("/(auth)/forgot-password")}>
                  <Text style={{ color: Colors.light.primary, fontFamily: Fonts.Inter_600SemiBold }}>Forgot password?</Text>
                </TouchableOpacity>
              </View>
            )
          }
        ...
        <View style={{ marginBottom: 8 }}>
          <TouchableOpacity
            onPress={emailExists ? continueToSignIn : onCheckIfUserExists}
            style={{
              height: 54,
              width: "100%",
              borderRadius: 8,
        ...
        <View style={tw`flex flex-row items-center gap-2 mb-[8px]`}>
          ...
          <Text style={{ fontFamily: Fonts.Inter_600SemiBold, fontSize: Typography.buttonText }}>or</Text>
          <View style={tw`flex-1 border-t border-zinc-400/30`} />
        </View>
        <GoogleAuthButton />
        <FacebookAuthButton />
